        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("EmailChek", "Email Like '_%@_%._%'");
                    table.CheckConstraint("PhoneChek", "Phone Like '010%' or Phone Like '011%' or Phone Like '012%' or Phone Like '015%'");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("EmailChek1", "Email Like '_%@_%._%'");
                    table.CheckConstraint("PhoneChek1", "Phone Like '010%' or Phone Like '011%' or Phone Like '012%' or Phone Like '015%'");
                });
