...
namespace GymManagement.DAL.Data.Migrations
{
    ...
    [Migration("20260726201856_AddIdentityTables")]
            ...
            modelBuilder.Entity("GymManagement.DAL.Models.Member", b =>
                {
                    ...
                    b.ToTable("Members", t =>
                        {
                            t.HasCheckConstraint("EmailChek", "Email Like '_%@_%._%'");

                            t.HasCheckConstraint("PhoneChek", "Phone Like '010%' or Phone Like '011%' or Phone Like '012%' or Phone Like '015%'");
                        });
                });
